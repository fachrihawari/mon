...
function Home() {
  return (
    <div className="bg-gray-100 p-3 flex items-center justify-center w-screen h-screen">
      <motion.div layoutId="container" className="bg-white border shadow-sm px-4 py-3 rounded-lg max-w-lg">
        <div className="flex items-center">
          <motion.img layoutId="user-img" className="h-12 w-12 rounded-full" src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"/>
          <div className="ml-2">
            <div className="text-sm ">
              <Link href="/profile">
                <span className="cursor-pointer font-semibold">Dallin Baumbach</span>
              </Link>
            ...
            <div className="text-gray-500 text-xs flex">
              ...
              <svg  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" data-supported-dps="16x16" fill="currentColor" className="inline-block ml-1 fill-current" width="16" height="16" focusable="false">
